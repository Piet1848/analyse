...
Continuum extrapolations should compare observables at fixed physical
...
One should instead compare at fixed ratios such as $r/\rzero$ or fixed
dimensionless distances built from another reference scale. If the measured
data only exist at discrete lattice separations, an interpolation in the
dimensionless observable, for example in $\chi a^2$ as a function of $r/a$, is
needed before fitting the continuum limit. This point is emphasized in recent
